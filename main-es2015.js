...
class CanvasComponent {
    ...
    renderBillboard(val) {
        const { title, organization, time, address, vol, topics, logoPath, } = val;
        const commonConfig = {
            size: 20,
            color: '#fff',
